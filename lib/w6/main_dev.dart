...
import 'package:mobile_dev_w4/w6/data/repositories/settings/app_settings_repository_mock.dart';
...
List<SingleChildWidget> get devProviders {
  return [
    ...
    ChangeNotifierProvider<AppSettingsState>(
      create: (_) {
        final state = AppSettingsState(repository: appSettingsRepository);
        state.init();
        return state;
      },
    ),
